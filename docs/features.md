...
- Optional macro folding: when the applied end of a chain expands to a known macro, an inline suggestion appears immediately after that suffix. Clicking it replaces only the matching suffix; the geometry and earlier chain remain unchanged.
