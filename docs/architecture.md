...
- tessellation-free hidden-face rim regions, including dihedral-aware opening widths, uninterrupted one-sided immersed source-edge sheets, exact source-vertex joins, width limits, and source-edge provenance;
...
outer and hole cycles. Their inner positions use
