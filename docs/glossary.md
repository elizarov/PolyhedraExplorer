...
| Greatening | A regular-star transform that changes a recognized Dodecahedron, Icosahedron, or Stellated dodecahedron to its supported great realization. It is serialized as `G`. |
| Stellation | Continuation of a recognized regular face-plane arrangement to a supported star form. The primitive `S` maps Dodecahedron to Stellated dodecahedron and Great dodecahedron to Great stellated dodecahedron. |
