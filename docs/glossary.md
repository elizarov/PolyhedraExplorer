...
| Primitive transform | A directly executable transform. The fixed primitive choices are Truncated, Rectified, Dual, Snub, Chamfered, and Canonical; topology-dependent Drop, Kis face, Truncate vertex, and Rectify vertex operations are also primitive. |
